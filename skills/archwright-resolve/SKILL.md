...
- Domain predicates (`../archwright-survey/references/domains/<domain>/predicates.yaml` + `general/predicates.yaml`, deployed with the survey skill — named, prior-art-backed design rules; cite matching predicates by id)
