...
**C5 folds into C10.** Its acceptance criterion ("one validated change-propagation walkthrough of the 6 growth rules, documented") carries over as a C10 deliverable, exercised during the DynamoRush reconciliation pass. Rationale: real change propagation beats synthetic fixture walks; growth rule 7 is now load-bearing for Q04's evidence design so it gets validated where it matters.
...
| 6 | C10: DynamoRush area-partitioned run + reconciliation + first TS emitter + C5 folded | 5h | 1,2,3 | C10, C5, B1-acceptance, C6-fog |
