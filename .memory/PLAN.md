...
> **Phase 6 (Discovery Track) OPEN (2026-07-18): ADR 0011 accepted via grill (6 Qs, `.memory/grill/discovery-track/`); spec `.memory/specs/discovery-track.md`; tickets 019–022, 024–027 DONE (026 conservation-check + 025 woz-export consumer shipped 2026-07-19). Remaining: 023 (field run — operator-driven), 028 (example projects). Ticket 018 (commit-binding of check evidence — verification-track) DONE 2026-07-19: code_state in check --json + evidence events, soft-decay staleness ratified as ADR 0009 amendment. Target: the operator's game project (not LBP — first non-LBP phase).**
