...
| `.memory/next-work-proposals.md` | `.tickets/` + PLAN.md phase planning (R15+ proposals predate the ticket system) | Confirm every still-relevant proposal has a ticket or an open-questions entry | 2026-07-19 |
| `.scratch/research/*.md` (session research dumps) | Findings synthesized into session artifacts | Automatic — `.scratch/` policy (never accumulate; promote or delete) | 2026-07-19 |
