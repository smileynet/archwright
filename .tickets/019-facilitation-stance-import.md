...
# Facilitation-stance reference (T1)

Distill the 4 wizard_of_oz patterns (`facilitated-agency`, `invisible-structure`, `propose-dont-force`, `wireframe-first`) into `skills/archwright-discover-ui/references/facilitation-stance.md`, with provenance citations back to `wizard_of_oz/design/patterns/` (Q1: cited snapshots, refreshed deliberately).
