...
**Next:** B1 (domain overlays — HITL shape decision w/ open question #9) · C3 (confidence lifecycle ADR) · C4 (emitter close-out/descope). Phase 5 execution under `.memory/PLAN.md`.
