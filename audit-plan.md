...
- **Open tickets remaining:** C3 (confidence lifecycle ADR, HITL) · C4 (emitter close-out, decision) · C5 (P3) · C10 (dynamodb-game-demo web run — closes B1-acceptance + C6-fog).
